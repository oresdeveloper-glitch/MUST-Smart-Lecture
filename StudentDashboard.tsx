...
export default function StudentDashboard() {
  ...
  const { user, timetable, announcements, assignments, attendanceRecords, notifications } = useApp();
    ...
    <div className="max-w-6xl mx-auto space-y-6 page-enter-stagger relative">
        ...
        <div className="relative overflow-hidden rounded-2xl must-shield-bg p-5 lg:p-6 shadow-xl shadow-[#0a1628]/20">
          ...
          <div className="relative flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div className="flex gap-2">
              ...
              <button className="px-4 py-2.5 rounded-xl bg-[var(--must-gold)] text-[#0a1628] text-sm font-bold hover:bg-[var(--must-gold-light)] transition-all hover:-translate-y-0.5 shadow-lg shadow-[var(--must-gold)]/30">
                Set Reminder
              </button>
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          ...
          <div key={i} className="premium-card p-4 group cursor-pointer" onClick={() => navigate(i === 0 ? `${basePath}/timetable` : i === 1 ? `${basePath}/assignments` : i === 2 ? `${basePath}/attendance` : `${basePath}/analytics`)}>

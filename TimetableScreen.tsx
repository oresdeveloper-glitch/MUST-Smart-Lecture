...
export default function TimetableScreen() {
  ...
  const getSlotOffset = (start: string) => {
    return parseInt(start.split(':')[0]) - 7;
  };
...
<p className="text-slate-500 dark:text-slate-400 text-sm mt-0.5">TE Fourth Year · Semester II · 2025/2026</p>
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="p-2 rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-400">

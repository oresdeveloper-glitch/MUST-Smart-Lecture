      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="premium-card p-5">
            ...
            <div className="space-y-2">
              {myCourses.map(c => (
                <div key={c.id} className="flex items-center gap-3 p-2.5 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors cursor-pointer">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-slate-400">{c.students.length} students</p>
                  </div>
                </div>
              ))}
            </div>
